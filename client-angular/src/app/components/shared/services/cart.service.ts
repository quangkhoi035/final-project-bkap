...
import {Observable, BehaviorSubject, Subscriber, observable} from 'rxjs';
...
// Array
  private baseUrl = 'http://localhost:8075/api/v1/orders';
  ...
  getOrderByUser(user : Object ): Observable<Order[]> {
    return this.http.post<Order[]>(`${this.baseUrl}/find-by-user`, user);
  }
